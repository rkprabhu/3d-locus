	      ...
	      equalheight = function(container){
	      	// alert("hi");
		        ...
		        $(window).resize(function(){
		         ...
		         /********* Checkout Tabindex Start ********/
		        $(window).load(function(){
		        	$(".checkout-index-index #customer-email-fieldset #customer-email").attr("tabindex","1");
		        	$(".checkout-index-index .search_area #gmap-search").attr("tabindex","2");
		        	$(".checkout-index-index .search_area #gmap-search").attr("tabindex","3");
		        	$(".checkout-index-index #shipping-new-address-form input[name='firstname']").attr("tabindex","4");
		        	$(".checkout-index-index #shipping-new-address-form input[name='lastname']").attr("tabindex","5");
		        	$(".checkout-index-index #shipping-new-address-form input[name='street[0]']").attr("tabindex","6");
		        	$(".checkout-index-index #shipping-new-address-form input[name='street[1]']").attr("tabindex","7");
		        	$(".checkout-index-index #shipping-new-address-form input[name='street[2]']").attr("tabindex","8");
		        	$(".checkout-index-index #shipping-new-address-form input[name='street[3]']").attr("tabindex","9");
		        	$(".checkout-index-index #shipping-new-address-form input[name='city']").attr("tabindex","10");
		        	$(".checkout-index-index #shipping-new-address-form select[name='region_id']").attr("tabindex","11");
		        	$(".checkout-index-index #shipping-new-address-form input[name='postcode']").attr("tabindex","12");
		        	$(".checkout-index-index #shipping-new-address-form input[name='telephone']").attr("tabindex","13");
		        });
		        /********* Checkout Tabindex End ********/
	 })
